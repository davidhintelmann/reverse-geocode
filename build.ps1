...
$WorkDir = "C:\Users\david\go\src\github.com\davidhintelmann\reverse-geocode"
$SystemVariable = "go"
$EmbedFile = "embed_csv.go"
$File = "main.go"
$EmbedBinary = "tmp.exe"
$Binary = "geo.exe"
$ArgumentBuild1 = ("build -o " + $EmbedBinary + " " + $EmbedFile)
...
$BuildTime = Measure-Command {
    Start-Process -FilePath $SystemVariable -WorkingDirectory $WorkDir -ArgumentList $ArgumentBuild1 -NoNewWindow -wait
}
